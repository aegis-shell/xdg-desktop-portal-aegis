...
/// keeps returning [`aegis_portal_ipc::MIN_PROTOCOL_VERSION`] at the call
...
mod tests {
    use super::*;
    use aegis_portal_ipc::testing::{CaptureOutputPayload, Handler, Server};
    use std::sync::Arc;
    ...
    fn protocol_version_is_remembered_process_wide() {
        ...
        assert!(
            remembered >= aegis_portal_ipc::MIN_PROTOCOL_VERSION,
